...
add wave -noupdate /pacman_loc_ctrl_testbench/curr_pacman_x
add wave -noupdate /pacman_loc_ctrl_testbench/curr_pacman_y
add wave -noupdate /pacman_loc_ctrl_testbench/next_pacman_x
add wave -noupdate /pacman_loc_ctrl_testbench/next_pacman_y
